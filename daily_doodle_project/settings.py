"""
Django settings for daily_doodle_project project.
...
# set up django-environ so we can use .env variables
env =environ.Env()
...
MIDDLEWARE = [
    ...
    "dailydoodle.middleware.PromptMiddleware",
]
...
WSGI_APPLICATION = 'daily_doodle_project.wsgi.application'
